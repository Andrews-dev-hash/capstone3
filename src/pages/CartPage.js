...
function CartPage() {
  ...
  const handleRemoveFromCart = async (productId) => {
    try {
      const response = await fetch(
        `https://nyosh-kick.onrender.com/users/cart/${productId}`,
        {
          method: "DELETE",
          headers: {
  ...
  const handleUpdateQuantity = async (productId, newQuantity) => {
    try {
      const response = await fetch(
        `https://nyosh-kick.onrender.com/users/cart/addToCart`,
        {
          method: "POST",
          headers: {
  ...
  const fetchCartData = () => {
    fetch(`https://nyosh-kick.onrender.com/users/cart/view`, {
      method: "GET",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
      },
  ...
  const handlePlaceOrder = async () => {
    try {
      const response = await fetch(
        `https://nyosh-kick.onrender.com/users/place-order`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
      ...
      if (response.ok) {
        const userResponse = await fetch(
          `https://nyosh-kick.onrender.com/users/details`,
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`,
